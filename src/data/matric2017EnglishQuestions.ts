...
export const matric2017EnglishQuestions: MatricExamQuestion[] = [
  {
    ...
    correctAnswer: 0,
    explanation: "Based on the passage's compassionate tone regarding homelessness, option A is most consistent with the text's message that some homeless people are victims of circumstances who deserve help.",
  },
  {
    id: "m2017-eng-2",
