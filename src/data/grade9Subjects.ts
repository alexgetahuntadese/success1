...
export const grade9Subjects: Grade9Subject[] = [
  ...
  },
  {
    ...
    name: "Amharic",
    icon: "Type",
    description: "Amharic language and literature study built around core language, genre, and social themes.",
    chapters: [
      "Chapter 1: Language",
      "Chapter 2: Work",
      "Chapter 3: Mining",
      "Chapter 4: Novel",
      "Chapter 5: Oral Literature",
      "Chapter 6: Poetry",
      "Chapter 7: COVID-19 (Corona)",
      "Chapter 8: Drama",
      "Chapter 9: Social Media and Communication",
    ],
    category: "Languages",
  },
  {
