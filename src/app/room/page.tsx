      ...
      <div className="mx-auto max-w-3xl">
        <Card className="overflow-hidden border border-slate-700 bg-slate-900/90 shadow-2xl backdrop-blur-xl">
          <CardHeader className="px-8 py-10 text-center">
            <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-sky-500 to-blue-500 text-slate-950 shadow-xl">
              <Users className="h-8 w-8" />
            </div>
            <CardTitle className="text-3xl font-semibold">Join Room</CardTitle>
            <CardDescription className="mt-2 text-slate-400">
              Join an existing session with peers.
            </CardDescription>
          </CardHeader>
