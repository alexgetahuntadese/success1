...
import { isParseConfigured } from "@/integrations/parse/parseConfig";
...
const PaymentDebug = () => {
  ...
  return (
    <div className="p-4 bg-black/10 rounded-lg text-white text-sm">
      ...
      <div>Parse Configured: {isParseConfigured ? "✅ Yes" : "❌ No"}</div>
      ...
      <div className="mt-4 p-3 bg-yellow-500/20 rounded">
        <p className="font-semibold">If Parse Configured shows "No":</p>
        <p>1. Copy .env.example to .env.local</p>
        <p>2. Add your Back4App credentials</p>
