...
const base = 'https://kehulum.com/entrance-exam/social%20science/2015/civics-and-ethical-education-194';
const pages = Array.from({ length: 12 }, (_, i) => `${base}/${i + 1}`);
...
export const matric2015SocialCivicsQuestions: MatricExamQuestion[] = ${JSON.stringify(
    questions,
    null,
    2
  )};
`;
  ...
  fs.writeFileSync('src/data/matric2015SocialCivicsQuestions.ts', out);
  console.log('Wrote src/data/matric2015SocialCivicsQuestions.ts with', questions.length, 'items');
}
