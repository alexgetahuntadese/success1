...
const base = 'https://kehulum.com/entrance-exam/social%20science/2015/history-193';
...
export const matric2015SocialHistoryQuestions: MatricExamQuestion[] = ${JSON.stringify(
    questions,
    null,
    2
  )};
`;
  ...
  fs.writeFileSync('src/data/matric2015SocialHistoryQuestions.ts', out);
  console.log('Wrote src/data/matric2015SocialHistoryQuestions.ts with', questions.length, 'items');
}
