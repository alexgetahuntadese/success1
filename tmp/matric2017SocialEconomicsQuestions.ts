...
const raw2017SocialEconomicsQuestions = [
  ...
  {
    "question": "Which one of the following is the objective of the national long-term plan after the reform of 2021 – 2030?",
    "options": [
  ...
  {
    "question": "Which one of the following was the objective of the third five year plan during the imperial period (1968 – 1973)?",
    "options": [
...
export const matric2017SocialEconomicsQuestions: MatricExamQuestion[] = raw2017SocialEconomicsQuestions.map((item, index) => ({
  ...
  correctAnswer: -1,
  explanation: "Answer key was not provided in the Kehulum source.",
}));
