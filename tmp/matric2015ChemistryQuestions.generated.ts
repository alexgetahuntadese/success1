...
const raw2015ChemistryAnswerKey = [
  ...
  { correctAnswer: -1, explanation: "This item depends on the source graph image, so the answer key is left unset." },
  ...
  { correctAnswer: -1, explanation: "This item depends on the source hybridization diagram image, so the answer key is left unset." },
  ...
  { correctAnswer: -1, explanation: "This item depends on the source structural formula image, so the answer key is left unset." },
